...
public Plugin:myinfo =
{
    ...
    author = "Medowar",
    description = "Redirects clients to your new IP with a message.",
    version = "1.0",
    url = "http://www.germangang.com/"
};

public OnPluginStart()
{
    HookEvent("player_spawn", EventSpawn);
    NewIP = CreateConVar("re_newip", "81.169.142.32", "Set to your new IP.", FCVAR_PLUGIN);
    Timer = CreateConVar("re_time", "125", "Seconds to kick after not leaving.", FCVAR_PLUGIN);
